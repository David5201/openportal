				...
				<div id="myCarousel" class="carousel slide">
				   ...
				   <div class="carousel-inner">
					  <div class="item active">
						 ...
						 <img src="dist/css/img/s1.jpg" alt="OpenPortal Portal协议WEB认证WIFI认证系统">
						 </a>
					  </div>
					  <div class="item">
					     <a href="http://www.openportal.com.cn" target="_blank">
						 <img src="dist/css/img/s2.jpg" alt="OpenPortal Portal协议WEB认证WIFI认证系统">
						 </a>
					  </div>
					  <div class="item">
					     <a href="http://www.openportal.com.cn" target="_blank">
						 <img src="dist/css/img/s3.jpg" alt="OpenPortal Portal协议WEB认证WIFI认证系统">
						 </a>
					  </div>
				   </div>
				   <!-- 轮播（Carousel）导航 -->
