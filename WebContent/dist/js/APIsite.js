$(document).ready(function() {
	...
	$("#guestLogin").click(function() {
		$("#guestLogin").attr('disabled',"true");
			var str="/ajax_WISPr_guest.action";
	...
	var gbasip;
	function guestHeart() {  
		var str="/ajax_WISPr_guestHeart.action?ip="+gip+"&basip="+gbasip;
		var data_str=encodeToUTF8(str);
    	$.ajax({ 
    		type : "GET", 
            url : data_str,
	...
	$("#guestAuth").click(function() {
			...
			//授权认证
			window.location.href = '/ajax_WISPr_guestAuth.action?ip='+ip+'&basip='+basip+'&mac='+mac;
	});
	//帐号密码认证
