  ...
  implements Serializable
{
  ...
  public String toString() {
    return "Portalap [id=" + this.id + ",basid=" + this.basid + ",ip=" + this.ip + ",mac=" + this.mac + ",address=" + this.address + ",basip=" + this.basip + ",x=" + this.x + ",y=" + this.y + ",des=" + this.des + ",name=" + this.name + ",web=" + this.web + ",count=" + this.count + "]";
  }
}
