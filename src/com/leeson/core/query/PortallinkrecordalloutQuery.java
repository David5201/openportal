...
/*     */ 
/*     */ public class PortallinkrecordalloutQuery extends BaseQuery
/*     */ {
/*     */   private Long id;
/*     */   private String name;
...
/*  16 */     return this.id;
/*     */   }
/*     */   public PortallinkrecordalloutQuery setId(Long id) {
/*  19 */     this.id = id;
/*  20 */     return this;
/*     */   }
/*     */ 
...
/*  24 */     return this.name;
/*     */   }
/*     */   public PortallinkrecordalloutQuery setName(String name) {
/*  27 */     this.name = name;
/*  28 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery setNameLike(boolean isLike) {
...
/*     */   }
/*     */   public PortallinkrecordalloutQuery setCreatDate(Date creatDate) {
...
/*  45 */     return this.url;
/*     */   }
/*     */   public PortallinkrecordalloutQuery setUrl(String url) {
/*  48 */     this.url = url;
/*  49 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery setUrlLike(boolean isLike) {
/*  53 */     this.urlLike = isLike;
/*  54 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery orderbyId(boolean isAsc)
/*     */   {
/*  97 */     this.orderFields.add(new OrderField("id", isAsc ? "ASC" : "DESC"));
/*  98 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery orderbyName(boolean isAsc)
/*     */   {
/* 107 */     this.orderFields.add(new OrderField("name", isAsc ? "ASC" : "DESC"));
/* 108 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery orderbyCreatDate(boolean isAsc)
/*     */   {
/* 117 */     this.orderFields.add(new OrderField("creatDate", isAsc ? "ASC" : "DESC"));
/* 118 */     return this;
/*     */   }
/*     */ 
/*     */   public PortallinkrecordalloutQuery orderbyUrl(boolean isAsc)
/*     */   {
 ...
 * Qualified Name:     com.leeson.core.query.PortallinkrecordalloutQuery
