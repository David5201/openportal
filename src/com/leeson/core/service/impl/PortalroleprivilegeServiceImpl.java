...
@Service
@Transactional
public class PortalroleprivilegeServiceImpl implements PortalroleprivilegeService {
	...
	public Pagination getPortalroleprivilegeListWithPage(PortalroleprivilegeQuery portalroleprivilegeQuery) {
		try {
			...
			page.setTotalCount(
					this.portalroleprivilegeDao.getPortalroleprivilegeListCount(portalroleprivilegeQuery).intValue());
