...
public class ArubaController extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    String pip = request.getParameter("ip");
    ...
    String pssid = request.getParameter("essid");
    ...
    session.setAttribute("api", "aruba");
