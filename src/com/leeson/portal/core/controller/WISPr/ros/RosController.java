...
public class RosController extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    String pip = request.getParameter("wlanuserip");
    String pmac = request.getParameter("mac");
    String purl = request.getParameter("url");
    String pbasip = request.getParameter("basip");
    ...
    System.out.println("basip=" + pbasip + "----ip=" + pip + "----mac=" + 
      pmac + "----url=" + purl + "----ssid=" + pssid + 
      "----loginUrl=" + loginUrl + "----result=" + result);
    ...
    if ((Tools.autoLogin(basip, ip, ikmac, basConfig, session)) && (!"1".equals(result))) {
      request.getRequestDispatcher("/APIGoAuthRos.jsp").forward(request, 
        response);
      return;
    }
